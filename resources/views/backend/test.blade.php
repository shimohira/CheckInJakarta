...
<head>
    ...
    <!-- Metrize Fonts -->
    <link href="backend/fonts/metrize.css" rel="stylesheet">
...
<script src="backend/js/flot/jquery.flot.time.js"></script>
<script src="backend/js/flot/jquery.flot.selection.js"></script>
<script src="backend/js/flot/jquery.flot.resize.js"></script>
<script src="backend/js/flot/jquery.flot.tooltip.js"></script>
<script src="backend/js/flot/flot.excanvas.min.js"></script>

<!-- Custom flot JS -->
<script src="backend/js/flot/custom/combine-chart.js"></script>

<!-- Animated Right Sidebar -->
<script src="backend/js/slidebars.js"></script>

<!-- Tyny Scrollbar -->
<script src="backend/js/tiny-scrollbar.js"></script>
...
<script src="backend/js/custom-index.js"></script>
